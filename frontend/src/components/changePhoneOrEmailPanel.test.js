...
// jest.mock('./WrappedChangePhoneOrEmailPanel');
let div;
...
test("and so is a spec", function () {
  let panel;
  ReactTestUtils.act(() => {
    // WrappedChangePhoneOrEmailPanel.props.mockResolvedValue({ location: { state: {username: "", password: ""} } });
    panel = ReactDOM.render(<HashRouter><WrappedChangePhoneOrEmailPanel /></HashRouter>, div);
