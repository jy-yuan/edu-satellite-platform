...
test("and so is a spec", function() {
  let panel;
  ReactTestUtils.act(() => {
    // loginPanel.props.mockResolvedValue({ location: { state: {username: "", password: ""} } });
    panel = ReactDOM.render(<HashRouter><WrappedNormalLoginForm /></HashRouter>, div);
