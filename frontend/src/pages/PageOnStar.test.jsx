...
import PageOnStar from "./PageOnStar";

// jest.mock('./PageOnStar');
let div;
...
test("and so is a spec", function () {
  let panel;
  ReactTestUtils.act(() => {
    // PageOnStar.props.mockResolvedValue({ location: { state: {username: "", password: ""} } });
    panel = ReactDOM.render(<HashRouter><PageOnStar /></HashRouter>, div);
