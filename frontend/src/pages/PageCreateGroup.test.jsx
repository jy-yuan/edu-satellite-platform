...
import PageCreateGroup from "./PageCreateGroup";

// jest.mock('./PageCreateGroup');
let div;
...
test("and so is a spec", function () {
  let panel;
  ReactTestUtils.act(() => {
    // PageCreateGroup.props.mockResolvedValue({ location: { state: {username: "", password: ""} } });
    panel = ReactDOM.render(<HashRouter><PageCreateGroup /></HashRouter>, div);
