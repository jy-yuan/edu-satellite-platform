...
import PageSatellite from "./PageSatellite";

// jest.mock('./PageSatellite');
let div;
...
test("and so is a spec", function () {
  let panel;
  ReactTestUtils.act(() => {
    // PageSatellite.props.mockResolvedValue({ location: { state: {username: "", password: ""} } });
    // panel = ReactDOM.render(<HashRouter><PageSatellite /></HashRouter>, div);
