...
import PageMyProgram from "./PageMyProgram";

// jest.mock('./PageMyProgram');
let div;
...
test("and so is a spec", function () {
  let panel;
  ReactTestUtils.act(() => {
    // PageMyProgram.props.mockResolvedValue({ location: { state: {username: "", password: ""} } });
    panel = ReactDOM.render(<HashRouter><PageMyProgram /></HashRouter>, div);
